...
public class EditNoteActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            knife.fromHtml(bean.getSummary());
            etTitle.setText(bean.getName());
        }catch (Exception e){
            bean = null;
        }
    ...
    private void setupBold() {
        ...
        bold.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "Bold", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupItalic() {
        ...
        italic.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "Italic", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupUnderline() {
        ...
        underline.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "Underline", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupStrikethrough() {
        ...
        strikethrough.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "Strike Through", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupBullet() {
        ...
        bullet.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "bullet", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupQuote() {
        ...
        quote.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "quote", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupLink() {
        ...
        link.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "insert_link", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    private void setupClear() {
        ...
        clear.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Toast.makeText(EditNoteActivity.this, "format_clear", Toast.LENGTH_SHORT).show();
                return true;
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_submit:
                ...
                if(!isEmpty(etTitle.getText().toString()) && !isEmpty(knife.getText().toString())){
                    if(bean == null)
                        new HttpUtil(HttpUtil.NORMAL_PARAMS)
                                ...
                                .add("date", FormatUtil.getCurrentDateOffset(0))
                                .add("name", etTitle.getText().toString())
                                .add("summary", knife.toHtml())
                                .get(Constant.URL_ADDNOTE, callback);
                    else
                        new HttpUtil(HttpUtil.NORMAL_PARAMS)
                                .add("uid", MyApplication.getPreferences(UserUtil.UID))
                                .add("token", MyApplication.getPreferences(UserUtil.TOKEN))
                                .add("noteid", bean.getNoteid())
                                .add("date", FormatUtil.getCurrentDateOffset(0))
                                .add("name", etTitle.getText().toString())
                                .add("summary", knife.toHtml())
                                .get(Constant.URL_UPDATENOTE, callback);

                }else{
                    Toast.makeText(this,"Insert Invalid",Toast.LENGTH_SHORT).show();
                }
    ...
    private BaseHttpRequestCallback callback = new BaseHttpRequestCallback() {
        ...
        public void onResponse(Response httpResponse, String response, Headers headers) {
            ...
            if (response == null || response.length() == 0) {
                Toast.makeText(EditNoteActivity.this, "Connect fail", Toast.LENGTH_SHORT).show();
            } else if(headers.get("Status-Code").equals("1")){
                Toast.makeText(EditNoteActivity.this, response , Toast.LENGTH_SHORT).show();
                finish();
            } else{
                Toast.makeText(EditNoteActivity.this, response , Toast.LENGTH_SHORT).show();
            }
